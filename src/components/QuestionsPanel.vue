...
const categories: QuestionCategory[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'radar-1', label: '500 m' },
      { id: 'radar-2', label: '1 km' },
      { id: 'radar-3', label: '2 km' },
      { id: 'radar-4', label: '5 km' },
      { id: 'radar-5', label: '10 km' },
      { id: 'radar-6', label: '15 km' },
      { id: 'radar-7', label: 'Custom distance' },
    ],
  },
  {
    id: 'tentacles',
