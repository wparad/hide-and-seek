...
export const stations: Station[] = [
  ...
  { name: 'Au', coordinates: [8.6436487, 47.2467896], lines: [] },
  ...
  { name: 'Bergstation Dolderbahn', coordinates: [8.5746371, 47.3731699], lines: [] },
  ...
  { name: 'Bubikon', coordinates: [8.8227427, 47.2709342], lines: ['S5', 'S15'] },
  ...
  { name: 'Dietikon AVA', coordinates: [8.4054779, 47.4047364], lines: [] },
  { name: 'Dietikon Stoffelbach', coordinates: [8.3988448, 47.3934346], lines: ['S17'] },
  { name: 'Dietlikon', coordinates: [8.6194099, 47.4202433], lines: ['S3', 'S8', 'S19'] },
  ...
  { name: 'Feldbach', coordinates: [8.7828935, 47.239099], lines: ['S7'] },
  ...
  { name: 'Hinwil', coordinates: [8.8397603, 47.3000892], lines: ['S14'] },
  ...
  { name: 'Kemptthal', coordinates: [8.7057857, 47.4530184], lines: ['S24'] },
  ...
  { name: 'Kollbrunn', coordinates: [8.7739581, 47.4584242], lines: ['S26'] },
  ...
  { name: 'Meilen', coordinates: [8.6443636, 47.2698432], lines: ['S6', 'S7', 'S20'] },
  { name: 'Mettmenstetten', coordinates: [8.4572421, 47.2441078], lines: ['S5'] },
  { name: 'Männedorf', coordinates: [8.6928142, 47.2533139], lines: ['S7', 'S20'] },
  ...
  { name: 'Oberglatt', coordinates: [8.510537, 47.4704172], lines: [] },
  ...
  { name: 'Pfäffikon', coordinates: [8.7847073, 47.3671002], lines: [] },
  {
    name: 'Pfäffikon SZ',
  ...
  { name: 'Rikon', coordinates: [8.7964912, 47.444857], lines: ['S26'] },
  { name: 'Ringlikon', coordinates: [8.4773667, 47.3602849], lines: ['S10'] },
  { name: 'Rämismühle-Zell', coordinates: [8.8194707, 47.4414619], lines: ['S26'] },
  { name: 'Räterschen', coordinates: [8.7951034, 47.4988091], lines: ['S12', 'S35'] },
  { name: 'Römerhof', coordinates: [8.5608667, 47.3684437], lines: [] },
  { name: 'Rümlang', coordinates: [8.5332376, 47.4540478], lines: ['S9', 'S15'] },
  { name: 'Rüschlikon', coordinates: [8.5551716, 47.3068825], lines: ['S8', 'S24'] },
  { name: 'Rüti', coordinates: [8.8543594, 47.260352], lines: [] },
  { name: 'Rüti ZH', coordinates: [8.8551497, 47.2602731], lines: ['S5', 'S15', 'S26'] },
  ...
  { name: 'Schlieren', coordinates: [8.4465178, 47.3992511], lines: ['S11', 'S12'] },
  {
  ...
  { name: 'Schwerzenbach', coordinates: [8.6587009, 47.3844343], lines: [] },
  ...
  { name: 'Schöneggstrasse', coordinates: [8.4009264, 47.4019779], lines: [] },
  ...
  { name: 'Stäfa', coordinates: [8.7223162, 47.2405471], lines: ['S7', 'S20'] },
  ...
  { name: 'Titlisstrasse', coordinates: [8.5651628, 47.3710953], lines: [] },
  { name: 'Turbenthal', coordinates: [8.8437649, 47.4371675], lines: ['S26'] },
  { name: 'Uerikon', coordinates: [8.752469, 47.2356832], lines: ['S7', 'S20'] },
  { name: 'Uetikon', coordinates: [8.6788756, 47.2591379], lines: [] },
  { name: 'Uetikon am See', coordinates: [8.6794073, 47.2587844], lines: ['S6', 'S7'] },
  ...
  { name: 'Waldhaus Dolder', coordinates: [8.5686173, 47.3732569], lines: [] },
  ...
  { name: 'Wila', coordinates: [8.8487032, 47.4178283], lines: ['S26'] },
  ...
  { name: 'Winkel', coordinates: [8.598947, 47.297289], lines: [] },
  ...
  { name: 'Zürich Tiefenbrunnen', coordinates: [8.5616716, 47.3503013], lines: ['S6', 'S16'] },
...
/**
 * Station ordering per line (fetched from transport.opendata.ch, filtered to known stations).
 * Routes only include stations in the `stations` array above. Lines that extend beyond
 * our zone (into SG, GL, AG, SH, TG) are truncated — the line connects our outermost
 * station directly to the next one in-zone, skipping external stops. This means the map
 * draws a straight line between zone-boundary stations even if intermediate stops exist
 * outside our dataset. This is intentional — we only track ZVV zone stations.
 */
export const lineRoutes: Record<string, string[]> = {
  ...
  S13: ['Wädenswil', 'Burghalden', 'Grüenfeld', 'Samstagern', 'Schindellegi-Feusisberg'],
  S14: [
    'Affoltern am Albis',
    'Hedingen',
    'Bonstetten-Wettswil',
  ...
  S17: ['Dietikon', 'Bergfrieden', 'Dietikon Stoffelbach', 'Reppischhof'],
  S18: [
    'Esslingen',
    'Egg',
    'Hinteregg',
  ...
  S21: ['Zürich Oerlikon', 'Zürich Altstetten', 'Regensdorf-Watt', 'Buchs-Dällikon'],
  S24: [
    'Thalwil',
    'Rüschlikon',
    'Zürich Wollishofen',
  ...
  S41: ['Winterthur', 'Pfungen', 'Embrach-Rorbas', 'Bülach'],
  S42: ['Dietikon', 'Glanzenberg', 'Schlieren', 'Zürich Altstetten'],
}
