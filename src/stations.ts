...
export const stations: Station[] = [
  ...
  { name: 'Blumenau', coordinates: [8.842395, 47.223666], lines: ['S6-SG', 'S17-SG'] },
  ...
  { name: 'Jona', coordinates: [8.83461, 47.230967], lines: ['S5', 'S15'] },
  ...
  { name: 'Kempraten', coordinates: [8.814304, 47.23839], lines: ['S7'] },
